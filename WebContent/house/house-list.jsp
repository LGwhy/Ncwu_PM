...
<div class="ch-container">
    <div class="row">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li><a class="ajax-link" href="admin?action=adminList"><i class="glyphicon glyphicon-cog"></i><span> &ensp;物&ensp;业&ensp;人&ensp;员&ensp;信&ensp;息</span></a>
							...
							<li class="active"><a class="ajax-link" href="house?action=houseList"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;租&ensp;赁&ensp;信&ensp;息</span></a>
                        </li>                    
					</ul>
                </div>
            </div>
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="house?action=houseList">租赁信息</a>
            </li>
        </ul>
    </div>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list-alt"></i> 租赁信息</h2>
