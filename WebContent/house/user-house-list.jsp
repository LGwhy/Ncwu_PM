...
<div class="ch-container">
    <div class="row">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="house?action=findByOwnerid&ownerid=${customAccount.ownerid }"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;租&ensp;赁&ensp;信&ensp;息</span></a>
                        </li>                  
					</ul>
                </div>
            </div>
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="house?action=findByOwnerid&ownerid=${customAccount.ownerid }">租赁信息</a>
            </li>
        </ul>
    </div>
