                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li><a class="ajax-link" href="../house?action=houseList"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;租&ensp;赁&ensp;信&ensp;息</span></a>
                        </li>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> 创建公告</h2>
				...
				<fieldset>
					...
					<div class="form-group">
						<div class="input-group col-md-5">
							...
							<textarea rows="20" cols="50" class="form-control" name="content" required></textarea>
							<span class="help-block with-errors"></span>
						</div>
					</div>
